...
class Display {
  ...
  handleAddFormClick () {
    ...
    if (!isFormValid) {
      ...
      this.storage.addTask(addTitle.value, (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(addDueDate.value), 'dd MMM yyyy'), addPriority.value);
